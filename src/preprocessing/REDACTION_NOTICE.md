...
This package is a privacy-redacted code-review copy of the project preprocessing implementation.
...
Record-specific correction blocks are represented as redacted/no-op review placeholders. Therefore this public-review copy is suitable for inspection of the preprocessing code and methodology, but it is **not** an executable substitute for the canonical private preprocessing source and cannot reproduce the complete raw-data pipeline exactly.
